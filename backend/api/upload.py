...
from backend.config import UPLOAD_MAX_BYTES, UPLOAD_ALLOWED_EXTENSIONS, UPLOAD_SOURCES_DIR
from backend.contracts import UploadResponse
from backend.db.connection import get_conn
from backend.db.repos.document import DocumentRepo
from backend.orchestrator import process_document
...
async def upload_document(
    ...
    with get_conn() as conn:
        ...
        doc_id = repo.create(source_path=str(dest), doc_type="unknown")
