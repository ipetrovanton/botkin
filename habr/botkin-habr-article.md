...
> - На тестовом стенде из 34 реальных документов — 34 из 34 успешных разборов, 100% совпадение показателей с эталоном, 13–14 секунд на документ. До оптимизации на отдельных бланках уходило больше семи минут.
...
> - Больше 640 тестов, Docker Compose, многопользовательский кабинет с ролями и один честно найденный (и закрытый) XSS.
